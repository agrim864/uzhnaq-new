document.addEventListener("DOMContentLoaded", () => {
  const currentPath = (
    window.location.pathname.split("/").pop() || "../index/index.html"
  ).toLowerCase();
  const isAboutPage = currentPath === "../about/about.html";
  const isExperimentHomepage = currentPath === "index-experiment.html";
  const homepagePaths = new Set(["../index/index.html", "index-experiment.html"]);
  const isHomepageLike = homepagePaths.has(currentPath);
  const shouldMountHomepageTitleAccent = currentPath === "../index/index.html";
  ...
  function syncHomepageHeroMachine() {
    if (currentPath !== "../index/index.html") {
      return;
    }
  ...
  function syncMachinesOverview(attempt = 0) {
    if (currentPath !== "../machines/machines.html") {
      return;
    }
  ...
  function highlightActiveLinks() {
    ...
    const triggerHighlightMap = {
      "../about/about.html": "undefined-1njxbrf",
      "../products/products.html": "undefined-14p26ei",
    };
